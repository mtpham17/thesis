...
```{r}
# Analyze
analyze <- function(data, p, true_beta, default, snr, sigma_r) {
  var.names <- paste("X", 1:p, sep = "")
  formula <- as.formula(paste("Y ~", paste(var.names, collapse = " + ")))
  ...
  print(paste("this is my sigma_r parameter:", sigma_r))
  l_range <- lambda_range_2(sigma_r)
  print(l_range)
...
file_saving_sim = function(chunkNo, seed, reps,
  ...
  {
    fname = paste0(root, "results/icc_sigma_r_2/",
               chunkNo, "_", seed, ".rds")
    res = NA
...
debugging = FALSE
sink(paste0(root, "logs/icc_sigma_r_2.txt"))
