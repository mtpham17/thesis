...
### BEGIN BRAINSTORMING FOR PREPROCESSING
...
### END BRAINSTORMING FOR PREPROCESSING
...
lambda_range <- lambda_range(df_analysis_largec, length(coefs_for_glm))
best_lambda <- cv_glmmLasso(df_analysis_largec, formula, rand = list(provid = ~1),
                            lambda_step = 20, min_lambda = lambda_range[1],
