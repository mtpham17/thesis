...
library(caret)
install.packages("fastDummies", repos="http://cran.r-project.org")
library(fastDummies)
...
install.packages("glmnet", repos="http://cran.r-project.org")
library(glmnet)
install.packages("glmmLasso", repos="http://cran.r-project.org")
library(glmmLasso)
install.packages("future", repos="http://cran.r-project.org")
library(future)
install.packages("furrr", repos="http://cran.r-project.org")
library(furrr)
