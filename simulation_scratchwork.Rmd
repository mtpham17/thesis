...
prelim_results <- rerun_mult_parameters(runs_vec = 50, 
                                        n_bar_vec = seq(from = 20, to = 100, by = 20),
                                        J_vec = 2:5, 
                                        alpha_vec = seq(from = 0, to = 1, 
                                                        by = 0.2),
                                        type_vec = 1:5,
                                        p_vec = seq(from = 5, to = 20, by = 5), 
                                        s_vec = seq(from = 1, to = 15, by = 5), 
                                        default_vec = 1,
                                        cov_x = seq(from = 0, to = 3, by = 1),
                                        scale_vec = seq(from = 0, to = 3, by = 1),
                                        base_mean_x_vec = 0, 
                                        sigma_x_vec = 1,
                                        mean_r_vec = 0, 
                                        sigma_r_vec = seq(from = 0, to = 3, by = 1),
                                        mean_noise_vec = 0, 
                                        sigma_noise_vec = 1)
```
...
save(results,file="prelim_results.Rda")
```
