...
file_saving_sim = function(chunkNo, seed, reps,
                           ...
                           mean_r, sigma_r, mean_noise, sigma_noise) 
  {
    ...
    fname = paste0("/n/home04/thupham17/thesis/results/020223_run/", 
               chunkNo, "_", seed, ".csv")
    res = NA
...
sink("/n/home04/thupham17/thesis/logs/output_020223.txt")
...
if (TRUE) {
    ...
    plan(multisession, workers = parallel::detectCores() - 30)
...
pathname <- "/n/home04/thupham17/thesis/results/020223_run"
if (TRUE) {
    # Run in parallel
...
write.csv(dataset[[1]], "/n/home04/thupham17/thesis/concat_results/020223_run.csv")
```
