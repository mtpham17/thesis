...
file_saving_sim = function(chunkNo, seed, reps,
  ...
  {
    fname = paste0(root, "results/with_icc_onerun/",
               chunkNo, "_", seed, ".rds")
    res = NA
...
debugging = FALSE
sink(paste0(root, "logs/icc_one_run.txt"))
...
pathname <- paste0(root, "results/with_icc_onerun")
if (TRUE) {
    # Run in parallel
...
write.csv(dataset[[1]], 
          paste0(root, "concat_results/with_icc_onerun.csv"))
```
