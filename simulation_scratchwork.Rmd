...
# beta-type 5: \beta has its first s components equal to default, and the rest decaying exponentially to 0, specifically \beta_i = default * 0.5^{i - s}, for i = s + 1, ..., p
...
test_beta <- generate_beta(1, 10, 3)
results <- analyze(test_df, 10, test_beta)
