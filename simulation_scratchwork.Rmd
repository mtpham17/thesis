...
generate_data <- function(j, n = 100, 
  ...
  # TODO: add some scaling in of the cluster intercept into the mean_x (those with higher
  # intercept values also have higher x values)
  ...
  data <- as.data.frame(cbind(noisy_x, rep(random_beta, each = n/j)))
