...
# set.seed(17)
# reps <- 20
# pathname <- paste0(root, "min_lambda/lambda_ranges.csv")
# 
...
#     write.csv(df, paste0(pathname, "_", snr, ".csv"))
#     return(df)
# }
```

```{r}
# snr_df <- data.frame("snr" = seq(0.14, 4, by = 0.3))
# # write.csv(dataset[[1]], 
...
```{r}
# data <- read.csv(paste0(root, "min_lambda/", gsub('\\.', '_', 
#                                                   as.character(min(snr_vec))),
#                  ".csv"))
# for (snr in snr_vec[-1]) {
#   new <- read.csv(paste0(root, "min_lambda/", gsub('\\.', '_', 
#                                                   as.character(snr)),
#                          ".csv"))
#   data <- rbind(data, new)
# }
...
# data <- data %>%
#   dplyr::select(-c("X"))
# write.csv(data, paste0(root, "min_lambdas.csv"))
```
