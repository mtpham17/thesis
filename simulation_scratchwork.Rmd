...
file_saving_sim = function(chunkNo, seed, reps,
  ...
  {
    # fname = paste0("/Users/thupham/Desktop/thesis/results/with_data_icc/", chunkNo, "_", seed, ".csv")
    fname = paste0("/n/home04/thupham17/thesis/results/with_data_icc/",
               chunkNo, "_", seed, ".csv")
    res = NA
...
debugging = FALSE
sink("/Users/thupham/Desktop/thesis/logs/with_data_icc.txt")
...
pathname <- "/Users/thupham/Desktop/thesis/results/with_data_icc"
if (TRUE) {
    # Run in parallel
...
write.csv(dataset[[1]], "/Users/thupham/Desktop/thesis/concat_results/with_data_icc.cvs")
```
