...
file_saving_sim = function(chunkNo, seed, reps,
  ...
  {
    fname = paste0(root, "results/snr_backup/",
               chunkNo, "_", seed, ".rds")
    res = NA
...
debugging = FALSE
sink(paste0(root, "logs/snr_backup.txt"))
...
if (!debugging) {
    ...
    plan(multisession, workers = parallel::detectCores() - 20)
...
if (TRUE) {
    ...
    plan(multisession, workers = parallel::detectCores() - 12)
