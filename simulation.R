...
# library(Require)
install.packages("readstata13", repos="http://cran.r-project.org")
library(readstata13)
Require("tidyverse", repos="http://cran.r-project.org")
Require("glmnet", repos="http://cran.r-project.org")
Require("caret", repos="http://cran.r-project.org")
Require("fastDummies", repos="http://cran.r-project.org")
Require("mvtnorm", repos="http://cran.r-project.org")
Require("dplyr", repos="http://cran.r-project.org")
Require("glmnet", repos="http://cran.r-project.org")
Require("glmmLasso", repos="http://cran.r-project.org")
Require("future", repos="http://cran.r-project.org")
Require("furrr", repos="http://cran.r-project.org")
Require("MASS", repos="http://cran.r-project.org")
Require("nlme", repos="http://cran.r-project.org")
Require("caret", repos="http://cran.r-project.org")
